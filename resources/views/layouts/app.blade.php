...
<body>
    ...
    <div class="sitename">
        <a class="navbar-brand textheader" href="{{ url('/') }}"> Amazing E-Grocery </a>
        @guest
        @if (Route::has('register'))
        <a href="{{ route('register') }}" class="btn buttonheader bg-warning text-dark">{{ __('Register') }}</a>
        @endif
        @if (Route::has('login'))
        <a href="{{ route('login') }}" class="btn buttonheader bg-warning text-dark">{{ __('Login') }}</a>
        @endif
        @else
        <a class="btn buttonheader bg-warning text-dark" href="{{ route('logout') }}"
