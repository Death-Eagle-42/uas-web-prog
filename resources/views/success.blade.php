...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="relative d-flex items-top justify-center" >
        <div class="circle1 rounded-circle border border-5 border-warning" style="width: 35%; line-height: 25vh;">
                <p class="c1 d-flex justify-center">Success!</p>
                <p class="c2 d-flex justify-center">We will contact you 1x24hours.</p>
                <a href="{{route('home')}}" class="c2 d-flex justify-center">Click here to 'Home'</a>
        </div>
        </div>
